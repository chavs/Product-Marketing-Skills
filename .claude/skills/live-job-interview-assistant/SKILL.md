...
- Live support for the Value Proposition Test exercise
...
- Any other live case-exercise format (GTM launch, GTM enablement/field-delivery, positioning and messaging, slides/presentation) — not yet built; don't stretch the Value Proposition Test workflow to cover them
...
- **Retrieval and critique, never authorship**, in the Value Proposition Test workflow specifically — see `References/value-proposition-test-practice.md`.
...
- **Value Proposition Test** — use when the candidate is currently working through the live roadmap-brief case exercise. Read `References/value-proposition-test-practice.md` before starting this workflow, every time. That file runs a structured intake → autonomous research → candidate draft → critique sequence, and its research phase calls back into the two research entry points above — don't reimplement that logic inline.
...
| `/value-proposition-test` | Value Proposition Test | Expect a brief to follow, same or next message. Reads `References/value-proposition-test-practice.md` before responding. |
